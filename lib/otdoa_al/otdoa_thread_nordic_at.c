...
// Each buffer is LTE_ACTIVE_SYMBOLS_PER_SUBFRAME_1PBCH*LTE_NUM_CARRIERS_PER_RB*8*sizeof(tRSTD_COMPLEX);
...
int otdoa_free_samples(void* pBuffer)
{
    ...
    ||   ((char*)pBuffer >= (_k_mem_slab_buf_nordic_prs_samples_slab+sizeof(_k_mem_slab_buf_nordic_prs_samples_slab))))
    {
